(function (root, factory) {
  ...
  function SpiralButton (options) {
    ...
    if (rotation) {
      buttonElement.classList.add(rotationClass);
    }

    if (debug) {
      buttonElement.classList.add("debug");
    }
    ...
    // Apply color scheme to spiral arms
    ...
    if (typeof colorScheme === "string") {
      var colorSchemeLookup = {
        ...
        watermelon: ["#FA6A75","#fb838c","#fc9ba3","#fdb4ba","#3ED071","#67da8f","#90e4ad"],
    ...
    var durationUnprefixed = "animation-duration: " + duration + "; ";
    var durationWebkit = "-webkit-" + durationUnprefixed;
  ...
  function getAnimationDurationString (duration) {
    if (!duration) {
      duration = "1500ms"; // default duration
    }
